...
internal class TransientScopeDisposalElementNodeMapper(IElementNodeMapperBase parentElementNodeMapper,
    ...
    : ElementNodeMapperBase(parentFunction,
        ...
        overridingElementNodeMapperFactory), ITransientScopeDisposalElementNodeMapper
{
    ...
    public override IElementNode Map(ITypeSymbol type, PassedContext passedContext)
    {
        if (type is INamedTypeSymbol namedType
            ...
            return transientScopeDisposalTriggerNodeFactory(namedType);
