...
internal class OverridingElementNodeWithDecorationMapper(IElementNodeMapperBase parentElementNodeMapper,
    ...
    : ElementNodeMapperBase(parentFunction,
        ...
        overridingElementNodeMapperFactory), IOverridingElementNodeWithDecorationMapper
{
    private readonly (INamedTypeSymbol InterfaceType, INamedTypeSymbol ImplementationType) _override = @override;
