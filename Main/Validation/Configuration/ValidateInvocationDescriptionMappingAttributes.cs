...
internal class ValidateInvocationDescriptionMappingAttributes : IValidateInvocationDescriptionMappingAttributes
{
    private readonly ILocalDiagLogger _localDiagLogger;
    private readonly HashSet<string> _acceptedMemberNames = new()
    {
        "TargetType", 
        "TargetMethod"
    };
