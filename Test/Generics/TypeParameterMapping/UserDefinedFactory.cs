...
// ReSharper disable once CheckNamespace
namespace MrMeeseeks.DIE.Test.Generics.TypeParameterMapping.UserDefinedFactory;
    ...
    [GenericParameterMapping(typeof(Dependency<,,>), "T2")] TC>
{
    ...
    private TB DIE_Factory_Value1 = (TB)(object)3L;
    private TC DIE_Factory_Value2 => (TC)(object)23.0;
}
