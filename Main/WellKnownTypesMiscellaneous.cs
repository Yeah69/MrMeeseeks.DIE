...
internal record WellKnownTypesMiscellaneous(
    ...
    INamedTypeSymbol InitializedInstancesForScopesAttribute,
    ...
    INamedTypeSymbol DieExceptionKind)
{
    internal static WellKnownTypesMiscellaneous Create(Compilation compilation) => new (
        ...
        InitializedInstancesForScopesAttribute: compilation.GetTypeByMetadataNameOrThrow(typeof(InitializedInstancesForScopesAttribute).FullName ?? ""),
