...
internal class MultiFunctionNode : ReturningFunctionNodeBase, IMultiFunctionNode, IScopeInstance
{
    ...
    private readonly Func<IFunctionNode, IRangeNode, IUserDefinedElementsBase, ICheckTypeProperties, IElementNodeMapper> _typeToElementNodeMapperFactory;
    ...
    internal MultiFunctionNode(
        ...
        Func<IFunctionNode, IRangeNode, IUserDefinedElementsBase, ICheckTypeProperties, IElementNodeMapper> typeToElementNodeMapperFactory,
    ...
    private IElementNodeMapperBase GetMapper(
        ...
        ICheckTypeProperties checkTypeProperties)
    {
        var baseMapper = _typeToElementNodeMapperFactory(parentFunction, parentNode, userDefinedElements, checkTypeProperties);
