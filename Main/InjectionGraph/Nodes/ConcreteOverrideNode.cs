...
internal sealed record ConcreteOverrideNodeData(ITypeSymbol Type)
{
    ...
    public bool Equals(ConcreteOverrideNodeData? other)
    {
...
internal sealed class ConcreteOverrideNode : IConcreteNode
{
