...
internal class BaseLogEnhancer : ILogEnhancer, IScopeInstance
{
    public string Enhance(string message) => message;
}

internal class FunctionLevelLogEnhancerDecorator : ILogEnhancer, IDecorator<ILogEnhancer>
{
...
internal class ContainerLevelLogEnhancerDecorator : ILogEnhancer, IDecorator<ILogEnhancer>
{
...
internal class ExecuteLevelLogEnhancerDecorator : ILogEnhancer, IDecorator<ILogEnhancer>
{
    private readonly ILogEnhancer _decoratedEnhancer;
