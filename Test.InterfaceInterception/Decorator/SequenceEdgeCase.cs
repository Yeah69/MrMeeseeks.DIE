...
namespace MrMeeseeks.DIE.Test.InterfaceInterception.Decorator.SequenceEdgeCase;
...
public sealed class Tests
{
    ...
    {
        await using var container0Then1 = Container.DIE_CreateContainer();
        ...
        await using var container1Then0 = Container.DIE_CreateContainer();
